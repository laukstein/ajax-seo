...
<form method=post>
    ...
    <ol class=install>
        ...
        <li><label for=cdn>CDN URL (optional)</label><input id=cdn name=cdn placeholder=//cdn.com/assets/ value="' . $cdn . '">
        <li class=i2>
        ...
        <li><hr><input class=button name=install value=Install type=submit>
    </ol>
</form>
<p>The configuration is saved in connect.php, after you can open and edit it manually.</p>';
