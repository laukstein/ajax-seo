...
if ($conn) {
    if (!connection) {
        // Google excludes content using HTML attribute "data-nosnippet" for span, div and section
        // http://webmasters.googleblog.com/2019/09/more-controls-on-search.html
        //
        // Yahoo excludes content using class=robots-nocontent
        // https://en.wikipedia.org/wiki/Meta_element#Robots-NoContent
        //
        // Yandex excludes content using non-standard element <noindex></noindex> and conditional comment <!--noindex--><!--/noindex-->
        // https://yandex.com/support/webmaster/controlling-robot/html.html#noindex

        // Chrome issue https://bugs.chromium.org/p/chromium/issues/detail?id=2763 requires "no-store" to avoid cache
...
<label for=note class=note data-nosnippet>Congratulations for successful installation</label>
<!--/noindex-->";
    ...
    // Not reachable database, SEO friendly blackout status
    // https://googlewebmastercentral.blogspot.com/2011/01/how-to-deal-with-planned-site-downtime.html
