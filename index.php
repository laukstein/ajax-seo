...
$js  = $debug ? '<script src="' . assets . "script.js#" . (strlen($path) ? $path : '/') . '"></script>' : '<script>!function(e){"use strict";"function"==typeof define&&define.amd?define(["as"],e):"object"==typeof module&&module.exports?module.exports=e():window.as=e()}(function(){"use strict";var e,t,r,s,a=window,n=document,o=history,i=location,l={classList:"classList"in n.documentElement,click:"click"in n.documentElement,eventListener:!!n.addEventListener,touch:a.hasOwnProperty("ontouchstart"),valid:function(e){try{return e()}catch(t){return l.valid.error.e=t,l.valid.error}}},c={bar:n.getElementById("bar"),focusin:n.getElementById("focusin"),focusout:n.getElementById("focusout"),reset:n.getElementById("reset"),nav:n.getElementById("nav"),status:n.getElementById("status"),output:n.getElementById("output")},u={toggleClass:function(e,t){if(e)if(l.classList)e.classList.toggle(t);else{var r=e.className.split(" "),s=r.indexOf(t);s>=0?r.splice(s,1):r.push(t),e.className=r.join(" ")}},toToggle:function(e){this.toggleClass(n.body.parentElement,"noscroll"),this.toggleClass(c.status,"expand"),e&&c.focusin&&setTimeout(function(){c.focusin.focus()},0)},toFocus:function(){n.activeElement!==c.focusin&&this.toToggle(!0)}},f={version:4.4,analytics:"' . ga . '",origin:function(){var e=n.currentScript||function(){var e=n.getElementsByTagName("script");return e[e.length-1]}(),t=e.src.split("#")[1]||"/ajax-seo";return"/"===t?location.origin:n.URL.replace(new RegExp("("+t+")(.*)$"),"$1")}(),url:n.URL,title:n.title,activeElement:function(){var e,t=n.querySelectorAll?n.querySelectorAll("[href]"):[];for(e=0;e<t.length;e+=1)if(t[e].href.toUpperCase()===n.URL.toUpperCase())return t[e];return null}(),error:c.status&&(l.classList?c.status.classList.contains("status-error"):new RegExp("(^|\\s)status-error(\\s|$)").test(c.status.className))};if(l.valid.error={e:null},f.analytics&&(a.ga=function(){ga.q=ga.q||[],ga.q.push(arguments)},ga("create",f.analytics,"' . ga_domain . '"),ga("send","pageview")),c.bar&&l.eventListener&&(c.bar.addEventListener("focus",function(){u.toToggle(!0)},!0),c.bar.addEventListener("click",function(){u.toFocus()},!0),c.nav&&c.nav.addEventListener("click",function(){u.toToggle(!0)},!0),c.focusout&&c.focusout.addEventListener("focus",function(){u.toToggle(!1)},!0),c.reset&&c.reset.addEventListener("click",function(){u.toToggle(!0)},!0)),!o.pushState||!l.classList||!l.eventListener)throw new Error("Browser legacy: History API not supported");if(!c.output)throw new Error("Layout issue: missing elements");return s={filter:function(e,t){return e?(e=e.replace(/#.*$/,""),t?e:e.toLowerCase()):void 0},reset:function(){t&&clearTimeout(t),c.status&&c.status.classList.contains("status-start")&&c.status.classList.add("status-done")},click:function(e){if(e)if(l.click)e.click();else{var t;t=n.createEvent("MouseEvents"),t.initEvent("click",!0,!0),e.dispatchEvent(t)}},nav:{nodeList:c.nav?Array.from?Array.from(c.nav.querySelectorAll("a")):[].slice.call(c.nav.querySelectorAll("a")):null,activeElement:function(){if(s.nav.nodeList){var e;for(e=0;e<s.nav.nodeList.length;e+=1)if(s.filter(s.nav.nodeList[e].href)===f.url)return s.nav.nodeList[e]}return null}},update:function(e,t,a){if(e){f.analytics&&ga("send","pageview",{page:f.url}),t?s.reset():r.abort(),s.nav.nodeList&&(c.focus=c.nav.querySelector(".focus"),c.active=c.nav.querySelector(".active"),c.error=c.nav.querySelector(".error"),c.focus&&c.focus.classList.remove("focus"),c.active&&c.active.classList.remove("active"),c.error&&c.error.classList.remove("error")),n.activeElement&&"BODY"===n.activeElement.tagName&&n.activeElement.blur(),f.url=s.filter(n.URL),a=a||s.nav.activeElement(),a&&(a.focus(),a.classList.add(f.error?"error":"active"),f.error&&a.classList.add("x-error")),f.error?(c.status.classList.add("error"),c.status.classList.add("status-error")):(c.status.classList.remove("error"),c.status.classList.remove("status-error")),n.title=f.title=e.title;var o=n.scrollingElement||n.documentElement.scrollTop||n.body;o.scrollTop=0,c.output.innerHTML=e.content,i.hash&&i.replace(f.url+i.hash)}},retry:!1,popstate:function(e){if(!(i.hash&&s.filter(f.url)===s.filter(n.URL)||f.url&&f.url.indexOf("#")>-1)){var t,r=e.state;s.reset(),s.retry=!r,f.error=r&&r.error||!1,r||(f.url=s.filter(n.URL),t=s.nav.activeElement(),s.click(t)),n.activeElement.blur(),s.update(r,!1,t)}},loadstart:function(){c.status&&(c.status.classList.remove("status-done"),c.status.classList.remove("status-start"),t&&clearTimeout(t),t=setTimeout(function(){c.status.classList.add("status-start")},0))},callback:function(e){f.error=e.error||!1,o.replaceState(e,e.title,null),s.update(e,!0)},load:function(){var t=this.response;t=l.valid(function(){return JSON.parse(t)}),e&&clearTimeout(e),s.callback(t===l.valid.error?{error:!0,title:"Server error",content:"<h1>Whoops...</h1><p>Experienced server error. Try to <a class=x-error href="+f.url+">reload</a>"+(f.url===f.origin?"":" or head to <a href="+f.origin+">home page</a>")+"."}:t)},closest:function(e,t){if(!e||!t)return null;if(e.closest)return e.closest(t);for(var r=e.matches||e.webkitMatchesSelector||e.msMatchesSelector;e&&1===e.nodeType;){if(r.call(e,t))return e;e=e.parentNode}return null},resetStatus:function(e){c.status&&(!c.status.classList.contains("status-error")||e&&f.error||c.status.classList.remove("status-error"),c.status.classList.contains("status-done")&&(c.status.classList.remove("status-start"),c.status.classList.remove("status-done")))},listener:function(t){if(t){var a=t.target,i=new RegExp("^"+f.origin+"($|#|/.{1,}).*","i"),l={};if(!a)return;if("A"!==a.tagName&&(a=s.closest(a,"a[href]")),!a||"A"!==a.tagName||!a.hasAttribute("href")||!i.test(a.href.replace(/\/$/,"")))return;if(f.url=a.href.toLowerCase().replace(/(\/)+(?=\1)/g,"").replace(/(^https?:(\/))/,"$1/").replace(/\/$/,""),l.attr=s.filter(f.url,!0),l.address=s.filter(n.URL),l.attr===l.address&&f.url.indexOf("#")>-1)return;if(t.preventDefault(),a.blur(),f.activeElement=a,f.activeNav=a.parentNode===c.nav,!s.retry&&f.activeNav&&(f.error=f.activeElement.classList.contains("x-error")),f.title=f.activeElement.innerText.replace(/\n/,"")||f.activeElement.textContent,f.error&&l.address===n.URL?o.replaceState(null,f.title,f.url):f.error||f.url===n.URL||o.pushState(null,f.title,f.url),!f.error&&!s.retry&&l.attr===l.address||f.activeNav&&f.activeElement.classList.contains("focus"))return;e&&clearTimeout(e),e=setTimeout(function(){n.title=f.title},3),s.resetStatus(),s.nav.nodeList&&(f.error&&f.activeNav&&(f.activeElement.classList.remove("x-error"),f.activeElement.classList.remove("error")),c.focus=c.nav.querySelector(".focus"),c.focus&&c.focus.classList.remove("focus")),f.activeNav&&f.activeElement.classList.add("focus"),r.abort(),r.open("GET",f.origin+"/api"+l.attr.replace(new RegExp("^"+f.origin,"i"),"")),f.error&&r.setRequestHeader("If-Modified-Since","Sat, 1 Jan 2000 00:00:00 GMT"),r.send()}},init:function(){c.status&&c.status.addEventListener("transitionend",s.resetStatus,!0),setTimeout(function(){a.onpopstate=s.popstate},150),o.replaceState({error:f.error,title:f.title,content:c.output.innerHTML},f.title,f.url),r=new XMLHttpRequest,r.onloadstart=s.loadstart,r.onload=s.load,r.onabort=s.reset,n.addEventListener(l.touch?"touchstart":"click",s.listener,!0)}},f.analytics||delete f.analytics,s.init(),f});</script>';
