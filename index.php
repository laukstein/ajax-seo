...
// Perform speed and security by removing referrer header http://www.w3.org/TR/referrer-policy/ http://wiki.whatwg.org/wiki/Meta_referrer
...
$js  = $debug ? '<script src="' . assets . "script.js#" . (strlen($path) ? $path : '/') . '" async></script>' : '<script>void function(e,t){"use strict";"object"==typeof module&&"object"==typeof module.exports?module.exports=t():"function"==typeof define&&define.amd?define(["as"],t):e.as=t()}(this,function(){"use strict";var e,t,r,a,s=window,o=document,n=history,i=location,l={bar:o.getElementById("bar"),focusin:o.getElementById("focusin"),focusout:o.getElementById("focusout"),reset:o.getElementById("reset"),nav:o.getElementById("nav"),status:o.getElementById("status"),output:o.getElementById("output")},c={toFocus:function(){o.activeElement!==l.focusin&&c.toToggle(!0)},toToggle:function(e){var t,r,a="expand",s=o.getElementById("status");s.classList?s.classList.toggle(a):(t=s.className.split(" "),r=t.indexOf(a),r>=0?t.splice(r,1):t.push(a),s.className=t.join(" ")),e&&setTimeout(function(){l.focusin.focus()},0)}},u={version:4,analytics:"' . ga . '",path:function(){var e=o.currentScript||function(){var e=o.getElementsByTagName("script");return e[e.length-1]}(),t=e.src.split("#")[1]||"/ajax-seo",r=new RegExp("("+t+")(.*)$");return o.URL.replace(r,"$1")}(),url:o.URL,title:o.title,activeElement:function(){var e,t=o.querySelectorAll?o.querySelectorAll("[href]"):[];for(e=0;e<t.length;e+=1)if(t[e].href===o.URL)return t[e];return null}(),error:!1};if(s.ga=function(){ga.q=ga.q||[],ga.q.push(arguments)},ga("create",u.analytics,"auto"),ga("send","pageview"),l.bar&&l.bar.addEventListener&&(l.bar.addEventListener("focus",function(){c.toToggle(!0)},!0),l.bar.addEventListener("click",c.toFocus,!0),l.nav&&l.nav.addEventListener("click",c.toToggle,!0),l.focusout&&l.focusout.addEventListener("focus",c.toToggle,!0),l.reset&&l.reset.addEventListener("click",c.toToggle,!0)),!n.pushState)throw new Error("Browser legacy: History API not supported");if(!l.output)throw new Error("Layout issue: missing elements");return a={filter:function(e){return e?e.replace(/#.*$/,"").toLowerCase():void 0},reset:function(){t&&clearTimeout(t),l.status&&l.status.classList.contains("status-start")&&l.status.classList.add("status-done")},click:function(e){if(e)try{e.click()}catch(t){var r=o.createEvent("MouseEvents");r.initEvent("click",!0,!0),e.dispatchEvent(r)}},nav:{nodeList:l.nav?Array.from?Array.from("a"):[].slice.call(l.nav.querySelectorAll("a")):null,activeElement:function(){var e;if(a.nav.nodeList)for(e=0;e<a.nav.nodeList.length;e+=1)if(a.filter(a.nav.nodeList[e].href)===u.url)return a.nav.nodeList[e];return null}},update:function(e,t,s,c){ga("send","pageview",{page:decodeURI(i.pathname)}),s?a.reset():r.abort();var f=i.hash;a.nav.nodeList&&(l.focus=l.nav.querySelector(".focus"),l.active=l.nav.querySelector(".active"),l.error=l.nav.querySelector(".error"),l.focus&&l.focus.classList.remove("focus"),l.active&&l.active.classList.remove("active"),l.error&&l.error.classList.remove("error")),o.activeElement&&"BODY"===o.activeElement.tagName&&o.activeElement.blur(),u.url=a.filter(o.URL),c=c||a.nav.activeElement(u.url),c&&(c.focus(),e.status&&(t="error"),c.classList.add(t),"error"===t&&(c.classList.remove("active"),c.classList.add("x-error")),c.classList.remove("x-error"),c.classList.remove("error")),o.title=u.title=e.title,l.output.innerHTML=e.content,f&&(n.replaceState({title:u.title,content:l.output.innerHTML},u.title,u.url),i.replace(u.url+f))},retry:!1,popstate:function(e){if(!(i.hash&&a.filter(u.url)===a.filter(o.URL)||u.url&&u.url.indexOf("#")>-1)){u.error=!1,a.retry=!1,a.reset();var t,r=e.state,s=r&&r.status?r.status:"active";r||(a.retry=!0,u.url=a.filter(o.URL),t=a.nav.activeElement(u.url),a.click(t)),s||(u.error=!0),u.error&&"active"===s&&(u.error=!1),a.update(r,s,!1,t)}},loadstart:function(){l.status&&(t=setTimeout(function(){l.status.classList.add("status-start")},100))},callback:function(e,t){u.error="active"===t?!1:!0,n.replaceState(e,e.title,null),a.update(e,t,!0)},load:function(){a.reset();var t=this.status;if(e&&clearTimeout(e),t)if(200!==t)a.callback({status:"error",title:"' . $pagetitle_error . '",content:"<h1>' . $title_error . '</h1><p>Sorry, this page hasn\'t been found. Try to <a class=x-error href="+u.url+">reload</a> the page or head to <a href="+u.path+">home</a>."},"error");else try{a.callback(JSON.parse(this.response),"active")}catch(r){a.callback({status:"error",title:"Server error",content:"<h1>' . $title_error . '</h1><p>Sorry, experienced server error. Try to <a class=x-error href="+u.url+">reload</a> the page or head to <a href="+u.path+">home</a>."},"error")}},closest:function(e,t){if(!e||!t)return null;if(e.closest)return e.closest(t);for(var r=e.matches||e.webkitMatchesSelector||e.msMatchesSelector;e&&1===e.nodeType;){if(r.call(e,t))return e;e=e.parentNode}return null},listener:function(t){if(t){var s=t.target,c=(i.host,new RegExp("^"+u.path+"($|#|/.{1,}).*","i")),f={};s&&("A"!==s.tagName&&(s=a.closest(s,"a[href]")),s&&"A"===s.tagName&&s.hasAttribute("href")&&c.test(s.href)&&(u.url=s.href.toLowerCase().replace(/(\/)+(?=\1)/g,"").replace(/(^https?:(\/))/,"$1/").replace(/\/$/,""),f.attr=a.filter(u.url),f.address=a.filter(o.URL),f.attr===f.address&&u.url.indexOf("#")>-1||(t.preventDefault(),s.blur(),u.activeElement=s,u.title=u.activeElement.innerText||u.activeElement.textContent,a.retry||(u.error=u.activeElement.classList.contains("x-error")),u.error&&f.address===o.URL?n.replaceState(null,u.title,u.url):u.error||u.url===o.URL||n.pushState(null,u.title,u.url),!u.error&&!a.retry&&f.attr===f.address||u.activeElement.classList.contains("focus")||(a.nav.nodeList&&(l.focus=l.nav.querySelector(".focus"),l.focus&&l.focus.classList.remove("focus")),u.activeElement.classList.remove("error"),u.activeElement.classList.add("focus"),e&&clearTimeout(e),e=setTimeout(function(){o.title=u.title},3),r.abort(),c=new RegExp("^"+u.path,"i"),r.open("GET",u.path+"/api"+u.url.replace(c,"")),u.error&&r.setRequestHeader("If-Modified-Since","Sat, 1 Jan 2000 00:00:00 GMT"),r.send()))))}},resetStatus:function(e){var t=e.target;t.contains("status-done")&&(t.classList.remove("status-start"),t.clacachessList.remove("status-done"))},init:function(){l.status&&l.status.addEventListener("transitionend",a.resetStatus,!0),setTimeout(function(){s.onpopstate=a.popstate},100),n.replaceState({title:u.title,content:l.output.innerHTML},u.title,u.url),r=new XMLHttpRequest,r.onloadstart=a.loadstart,r.onload=a.load,r.onabort=a.reset,o.addEventListener(s.hasOwnProperty("ontouchstart")?"touchstart":"click",a.listener,!0)}},a.init(),u});</script>';
