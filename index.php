...
<meta charset=utf-8>
$metadata
". ($debug ? '<link rel=stylesheet href=' . assets . "style.css>" : '<style>body,h1{font-size:1.9em}cite,main{display:block}a[href],html{cursor:default}button,input,label,select{vertical-align:middle}::selection,code,pre{background-color:rgba(206,209,210,.4)}html,img{max-width:100%}@viewport{width:device-width;zoom:1}body,html{height:100%}button,html,input,select,textarea{color:#222;font-family:Cambria,Georgia,serif}blockquote cite,h2{color:#777}.button,::-webkit-input-placeholder,button,html,input,label{-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}html{font-size:62.45%;line-height:1.5;text-rendering:optimizeSpeed;background-color:#f8f9fa;-ms-touch-action:manipulation;touch-action:manipulation}blockquote,body,dd,dl,figure{margin:0}body{overflow-wrap:break-word;-ms-hyphenate-limit-chars:6 3 2;hyphenate-limit-chars:6 3 2;-webkit-hyphens:auto;-moz-hyphens:auto;-ms-hyphens:auto;hyphens:auto}main{-webkit-user-select:text;-moz-user-select:text;-ms-user-select:text;user-select:text}dt,h1,h2,h3{line-height:1.07;font-weight:400;font-family:Times New Roman,serif}h1,h2{margin-top:.2em;margin-bottom:.2em}h1:first-line,h2:first-line{font-size:150%}h2{font-size:1.5em}dt,h3{margin-top:.3em;margin-bottom:.3em;font-size:1.35em}h4{margin-top:.4em;margin-bottom:.4em}small{font-size:70%}blockquote{padding-left:1.2em;font-style:italic;border-left:.3em solid #eef0f0}blockquote cite:before{content:"\2014 \00A0";color:#777}#status.status-start:before,.header:after,.main [id]:target:before{content:""}br{word-spacing:0}hr{position:relative;margin:1em -4.9vw;clear:both;border-width:0;border-top:1px solid #eef0f0}#status,.tab{position:fixed}code,pre{padding:.05em .3em;font-style:italic;font-family:Consolas,Liberation Mono,Courier,monospace;white-space:pre-wrap;-moz-tab-size:4;tab-size:4}.footer,.tab{white-space:nowrap}a,button,input,select,textarea{outline:0;pointer-events:auto}a img,abbr,iframe{border:0}a,img{-webkit-user-drag:none;user-drag:none}a[href]{color:#0f4cd5;text-decoration:none;-webkit-box-decoration-break:clone;box-decoration-break:clone}a[href]:focus,a[href]:hover{color:#0e439b;text-decoration:underline}.footer a,.main a:target,.nav.nav a,a[href].button{text-decoration:none}img{width:auto;height:auto;vertical-align:top;-ms-interpolation-mode:nearest-neighbor;image-rendering:-webkit-optimize-contrast;image-rendering:-moz-crisp-edges;image-rendering:crisp-edges}abbr{border-bottom:1px dotted #ccc}legend{display:table}label{display:inline-block;padding-bottom:.2em;padding-top:.2em;line-height:1.2}::selection{text-shadow:none}:placeholder-shown{opacity:.54;color:inherit}.button,button,input,select,textarea{width:20em;max-width:100%;padding:.6em .7em;margin:.15em 0;font-size:1em;line-height:1.25;background-color:#fff;border:1px solid #b1b2b2;box-sizing:border-box}textarea{overflow-x:hidden;overflow-y:scroll;min-height:4.95em;max-height:13em;word-wrap:break-word;resize:none}.main,.wrapper{min-height:100vh}.footer,.main,.nav,.nav span,div.noscroll{overflow:hidden}input:focus,input:hover,textarea:focus,textarea:hover{border-color:#9f9f9f;box-shadow:inset 0 1px 3px rgba(0,0,0,.15)}[type=checkbox],[type=color],[type=file],[type=image],[type=radio]{width:auto;padding:0;border:0;box-sizing:padding-box}.button,button,select{overflow:hidden;display:inline-block;white-space:nowrap;text-align:center;text-overflow:ellipsis;background-color:#f4f4f4;border:1px solid #c0c0c1;outline:0;box-shadow:inset 0 0 0 1px #f5f5f5,1px 1px 2px rgba(0,0,0,.1)}.button{width:auto}a[href].button{color:inherit}.button:focus,.button:hover,button:focus,button:hover,select:focus,select:hover{background-color:#f8f9fa;border-color:#9f9f9f}.nav .active+a,.nav a.active{border-color:transparent}.button:active,button:active,select:active{background-color:rgba(206,209,210,.4);box-shadow:none}option[value=""]{display:none}[tabindex]{outline:0}html{width:100vw}.wrapper{width:100vw}#status{opacity:0;z-index:999;left:0;width:0;height:3px;background-color:#006cff;box-shadow:0 0 0 1px rgba(255,255,255,.8);-webkit-transform:translateZ(0);-ms-transform:translateZ(0);transform:translateZ(0);-webkit-backface-visibility:hidden;backface-visibility:hidden;-webkit-perspective:1000;perspective:1000;will-change:transition}#status.status-start:before{display:block;width:1em;height:100%;float:right;background-image:-webkit-linear-gradient(left,rgba(0,194,255,0),#00c2ff);background-image:linear-gradient(to right,rgba(0,194,255,0),#00c2ff);box-shadow:3px -2px 5px 1px #00c2ff}#status.status-start{opacity:1;width:70%;-webkit-transition:opacity .2s,width 5s cubic-bezier(.2,1,.4,1);transition:opacity .2s,width 5s cubic-bezier(.2,1,.4,1)}#status.status-done{width:100%;opacity:0;-webkit-transition-duration:.2s;transition-duration:.2s}.tab{z-index:100;top:0;right:0;left:0;width:100vw;line-height:2.2;font-family:Segoe UI,Open Sans,sans-serif;text-align:center}.bar,.focusout{display:none;box-suppress:discard}.footer,.header,.main{width:95%;max-width:900px;margin:auto;box-sizing:border-box}.header,.main{background-color:#fff;border:0 solid #d9e0e2;border-width:0 1px}.header{position:relative;padding:.1em .4em}.header:after{position:absolute;left:0;right:0;height:1.5em;background-image:-webkit-linear-gradient(#fff,rgba(255,255,255,.9) 35%,rgba(255,255,255,.8) 50%,rgba(255,255,255,0));background-image:linear-gradient(#fff,rgba(255,255,255,.9) 35%,rgba(255,255,255,.8) 50%,rgba(255,255,255,0));pointer-events:none}.footer,.main,.nav a,.nav span{position:relative}.nav{display:inline-block;display:-webkit-box;display:-ms-flexbox;display:flex;width:100%;margin:.1em auto;font-size:1.05em;background-color:#f4f4f4;background-image:-webkit-linear-gradient(#f8f8f8,rgba(248,249,250,0));background-image:linear-gradient(#f8f8f8,rgba(248,249,250,0));border:1px solid #d9e0e2;border-bottom-color:#ccc;border-radius:.2em;box-shadow:0 1px 1px rgba(0,0,0,.1),inset 0 0 0 1px rgba(255,255,255,.5)}.footer a,.nav.nav a{color:inherit}.nav a{display:block;z-index:1;-webkit-box-flex:1;-ms-flex:1;flex:1;flex-basis:auto;min-width:1px;max-height:2.3em;padding:0 .43em;border:0 solid #d9e0e2;border-left-width:1px}.nav a:first-child{border-left:0}.nav a:first-of-type{border-radius:.2em 0 0 .2em}.nav a:last-of-type{border-radius:0 .2em .2em 0}.nav a:focus,.nav a:hover{background-color:#fff}.nav a.focus{background-color:rgba(206,209,210,.4)}.nav a.error{background-color:#f1e2e2}.nav a.active{margin:-1px auto;color:#fff;line-height:2.25;background-color:#006cff}.nav span{display:block;top:-.06em;text-overflow:clip;-webkit-mask:linear-gradient(to left,rgba(0,0,0,0),#000 1.5em,#000);mask:linear-gradient(to left,rgba(0,0,0,0),#000 1.5em,#000)}.footer,.main{padding:0 4.9vw}.main{padding-top:3.8em;padding-bottom:6em;will-change:contents}.main :target{background-color:#ff0}.main a:target:hover{text-decoration:underline}.main [id]:target:before{display:block;padding-top:3.5em;margin-top:-3.5em;pointer-events:none;background-color:#fff}.main h1[id]:target:before{padding-top:1.3em;margin-top:-1.3em}.footer{height:2.7em;margin-top:-2.7em;line-height:2.7;text-overflow:ellipsis;border-top:1px solid #eee}.footer a{display:inline-block;color:#777}.footer a+a{margin-left:.6em}.footer a:focus,.footer a:hover{color:#222;text-decoration:underline}template{display:none;box-suppress:discard}@media \0screen\,screen\9{.main,.noscroll,.wrapper{height:100%}.main,.noscroll.noscroll{overflow:visible}.nav{display:table;table-layout:fixed}.nav a{display:table-cell}.footer,.handler,[hidden]{display:none}}@media (min-width:0\0)and (min-resolution:.001dpcm){.nav,.nav a:first-of-type,.nav a:last-of-type{border-radius:0}.nav{display:table;table-layout:fixed}.nav a{display:table-cell}.handler,[hidden]{display:none}}@media (-ms-high-contrast:active),(-ms-high-contrast:none){.nav,html,textarea{-ms-overflow-style:-ms-autohiding-scrollbar}a{background-color:initial}select{-ms-user-select:none}:-ms-input-placeholder{opacity:.54}::-ms-clear{display:none}select:focus::-ms-value{color:initial;background-color:initial}[hidden]{display:none;box-suppress:discard}}@media (-webkit-min-device-pixel-ratio:0){.nav,html,textarea{-webkit-overflow-scrolling:touch}html{-webkit-font-smoothing:antialiased;-webkit-text-size-adjust:100%}[tabindex],a,button,input,select,textarea{-webkit-tap-highlight-color:transparent}a{-webkit-touch-callout:none}::-webkit-input-placeholder{opacity:.54;color:inherit;-webkit-user-select:none}}@-moz-document url-prefix(){::-moz-selection{text-shadow:none;background-color:rgba(206,209,210,.4)}label:active{background-color:transparent}button,input,select,textarea{background-image:none;border-radius:0}button::-moz-focus-inner,input::-moz-focus-inner{border:0;padding:0}}@media (max-width:540px){.bar,.bar span{position:relative}.bar span:after,.bar span:before,.header:after,.header:before{content:""}html{background-color:#fff}html.noscroll{overflow:hidden}hr{margin-right:-1.7em;margin-left:-1.7em}button,input,label,textarea{width:100%}[type=checkbox],[type=color],[type=file],[type=image],[type=radio]{width:auto}#status:not(.expand)~.tab .header{-webkit-transition:none;transition:none}.tab{z-index:100;width:100%;width:75%\9\0;padding-bottom:.2em;text-align:left;text-align:start;background-image:-webkit-linear-gradient(#fff,rgba(255,255,255,.9) 35%,rgba(255,255,255,.8) 50%,rgba(255,255,255,0));background-image:linear-gradient(#fff,rgba(255,255,255,.9) 35%,rgba(255,255,255,.8) 50%,rgba(255,255,255,0));pointer-events:none}.bar{width:auto;height:2.35em;padding:inherit;margin:inherit;background-color:transparent;border:inherit inherit inherit;box-shadow:inherit;all:unset;display:inline-block;vertical-align:top;z-index:3}.bar,.nav{pointer-events:auto}.bar:focus,.bar:hover{background-color:rgba(206,209,210,.4)}.bar span,.bar span:after,.bar span:before{display:block;width:1.3em;height:.21em;background-color:#222;border-radius:.1em;-webkit-transition:width .1s,background-color 1ms,-webkit-transform .35s cubic-bezier(.2,1,.4,1);transition:width .1s,background-color 1ms,transform .35s cubic-bezier(.2,1,.4,1)}.bar span{margin:1.07em .65em 1.07em .55em;transform:translateY(0);-webkit-transition-duration:.15s;transition-duration:.15s;will-change:transition,transform;pointer-events:none}.bar span:before{position:absolute;-webkit-transform:translateY(-.42em);-ms-transform:translateY(-.42em);transform:translateY(-.42em)}.bar span:after{position:absolute;width:.9em;-webkit-transform:translateY(.42em);-ms-transform:translateY(.42em);transform:translateY(.42em)}.expand~.tab .bar span{background-color:transparent}.expand~.tab .bar span:before{-webkit-transform:rotate(45deg);-webkit-transform:rotate3d(0,0,1,45deg);-ms-transform:rotate(45deg);transform:rotate3d(0,0,1,45deg)}.expand~.tab .bar span:after{width:1.3em;-webkit-transform:rotate(-45deg);-webkit-transform:rotate3d(0,0,1,-45deg);-ms-transform:rotate(-45deg);transform:rotate3d(0,0,1,-45deg)}.expand~.tab .header{-webkit-transform:none;-ms-transform:none;transform:none;box-shadow:0 0 4em rgba(0,0,0,.3)}.focusout{display:inline}.header{position:fixed;top:0;left:0;bottom:0;width:75%;padding:0;background-color:#f8f9fa;border:0;-webkit-transform:translateX(-100%);-ms-transform:translateX(-100%);transform:translateX(-100%);-webkit-transition:-webkit-transform .35s cubic-bezier(.2,1,.4,1);transition:transform .35s cubic-bezier(.2,1,.4,1)}.header:after,.header:before{opacity:0;position:fixed;left:0;z-index:2;width:75%;height:2.35em;pointer-events:none;transition:opacity .35s cubic-bezier(.2,1,.4,1)}.header:before{top:0;background-image:-webkit-linear-gradient(#f8f9fa,rgba(248,249,250,.9) 50%,rgba(248,249,250,.8) 60%,rgba(248,249,250,0));background-image:linear-gradient(#f8f9fa,rgba(248,249,250,.9) 50%,rgba(248,249,250,.8) 60%,rgba(248,249,250,0))}.header:after{bottom:0;right:auto;background-image:-webkit-linear-gradient(rgba(248,249,250,0),rgba(248,249,250,.8) 50%,rgba(248,249,250,.9) 60%,#f8f9fa);background-image:linear-gradient(rgba(248,249,250,0),rgba(248,249,250,.8) 50%,rgba(248,249,250,.9) 60%,#f8f9fa)}.expand~.tab .header:after,.expand~.tab .header:before{opacity:1}.expand~.handler,.expand~.tab .handler{position:inherit;top:0;right:0;left:0;bottom:0;margin:0}.expand~.handler{position:fixed;z-index:99}.nav,.nav a:first-of-type,.nav a:last-of-type{border-radius:0}.nav{overflow:auto;display:block;height:100%;padding:2.3em 0;margin:0;background:0 0;border:0;box-shadow:none;box-sizing:border-box}.nav.nav a{display:block;-webkit-box-flex:0;-webkit-flex:0;-ms-flex:0;flex:0;padding:0 1.3em;float:none;border-color:#eef0f0;border-width:1px 0 0}.nav a:first-child{border-top-width:0}.main{width:auto;min-width:13.6em;padding:2em 1.9em 3.2em;border:0}.main [id]:before{padding-top:1.8em;margin-top:-1.8em}.footer{display:none}}@media (max-width:320px){html{font-size:58%}h1{font-size:1.5em}h2{font-size:1.2em}dt,h3{font-size:1.3em}}@media print{*,.main,h2,h3,html{background:0 0}@page{margin:.5cm}*,h2,h3{color:#222;text-shadow:none}h2,h3,p{orphans:3;widows:3}h2,h3{page-break-after:avoid}a{color:#777;text-decoration:underline}img{page-break-inside:avoid}.footer,.tab{display:none}.main{padding-top:1em;padding-bottom:1em;border-width:0}.button,button,select{box-shadow:none}}</style>') . "
