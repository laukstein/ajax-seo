...
$js  = $debug ? '<script src="' . assets . "script.js#" . (strlen($path) ? $path : '/') . '"></script>' : '<script>!function(e){"use strict";"function"==typeof define&&define.amd?define(["as"],e):"object"==typeof module&&module.exports?module.exports=e():window.as=e()}(function(){"use strict";var e,t,r,s,a=window,o=document,n=history,i=location,l={classList:"classList"in o.documentElement,click:"click"in o.documentElement,eventListener:!!o.addEventListener,touch:a.hasOwnProperty("ontouchstart"),valid:function(e){try{return e()}catch(t){return l.valid.error.e=t,l.valid.error}}},c={bar:o.getElementById("bar"),focusin:o.getElementById("focusin"),focusout:o.getElementById("focusout"),reset:o.getElementById("reset"),nav:o.getElementById("nav"),status:o.getElementById("status"),output:o.getElementById("output")},u={toggleClass:function(e,t){if(e)if(l.classList)e.classList.toggle(t);else{var r=e.className.split(" "),s=r.indexOf(t);s>=0?r.splice(s,1):r.push(t),e.className=r.join(" ")}},toToggle:function(e){this.toggleClass(o.body.parentElement,"noscroll"),this.toggleClass(c.status,"expand"),e&&c.focusin&&setTimeout(function(){c.focusin.focus()},0)},toFocus:function(){o.activeElement!==c.focusin&&this.toToggle(!0)}},v={version:4.6,analytics:"' . ga . '",origin:function(){var e=o.currentScript||function(){var e=o.getElementsByTagName("script");return e[e.length-1]}(),t=e.src.split("#")[1]||"/ajax-seo";return"/"===t?location.origin:o.URL.replace(new RegExp("("+t+")(.*)$"),"$1")}(),url:o.URL,title:o.title,activeElement:function(){var e,t=o.querySelectorAll?o.querySelectorAll("[href]"):[];for(e=0;e<t.length;e+=1)if(t[e].href.toUpperCase()===o.URL.toUpperCase())return t[e];return null}(),error:c.status&&(l.classList?c.status.classList.contains("status-error"):new RegExp("(^|\\s)status-error(\\s|$)").test(c.status.className))};if(l.valid.error={e:null},v.analytics&&(a.ga=function(){ga.q=ga.q||[],ga.q.push(arguments)},ga("create",v.analytics,"' . ga_domain . '"),ga("send","pageview")),c.bar&&l.eventListener&&(u.toToggle["true"]=function(){u.toToggle(!0)},u.toToggle["false"]=function(){u.toToggle(!1)},u.toFocus.run=function(){u.toFocus()},u.run=function(){o.documentElement.offsetWidth<=540?(c.bar.addEventListener("focus",u.toToggle["true"],!0),c.bar.addEventListener("click",u.toFocus.run,!0),c.nav&&c.nav.addEventListener("click",u.toToggle["true"],!0),c.focusout&&c.focusout.addEventListener("focus",u.toToggle["false"],!0),c.reset&&c.reset.addEventListener("click",u.toToggle["true"],!0)):(c.bar.removeEventListener("focus",u.toToggle["true"],!0),c.bar.removeEventListener("click",u.toFocus.run,!0),c.nav&&c.nav.removeEventListener("click",u.toToggle["true"],!0),c.focusout&&c.focusout.removeEventListener("focus",u.toToggle["false"],!0),c.reset&&c.reset.removeEventListener("click",u.toToggle["true"],!0))},u.run(),a.addEventListener("resize",function(){u.timeoutScale&&clearTimeout(u.timeoutScale),u.timeoutScale=setTimeout(u.run,100)},!0)),!n.pushState||!l.classList||!l.eventListener)throw new Error("Browser legacy: History API not supported");if(!c.output)throw new Error("Layout issue: missing elements");return s={filter:function(e,t){return e?(e=e.replace(/#.*$/,""),t?e:e.toLowerCase()):void 0},reset:function(){t&&clearTimeout(t),c.status&&c.status.classList.contains("status-start")&&c.status.classList.add("status-done")},click:function(e){if(e)if(l.click)e.click();else{var t;t=o.createEvent("MouseEvents"),t.initEvent("click",!0,!0),e.dispatchEvent(t)}},nav:{nodeList:c.nav?Array.from?Array.from(c.nav.querySelectorAll("a")):[].slice.call(c.nav.querySelectorAll("a")):null,activeElement:function(){if(s.nav.nodeList){var e;for(e=0;e<s.nav.nodeList.length;e+=1)if(s.filter(s.nav.nodeList[e].href)===v.url)return s.nav.nodeList[e]}return null}},update:function(e,t,a){if(e){v.analytics&&ga("send","pageview",{page:v.url}),t?s.reset():r.abort(),s.nav.nodeList&&(c.focus=c.nav.querySelector(".focus"),c.active=c.nav.querySelector(".active"),c.error=c.nav.querySelector(".error"),c.focus&&c.focus.classList.remove("focus"),c.active&&c.active.classList.remove("active"),c.error&&c.error.classList.remove("error")),o.activeElement&&"BODY"===o.activeElement.tagName&&o.activeElement.blur(),v.url=s.filter(o.URL),v.activeElement=a||s.nav.activeElement(),v.activeElement&&(v.activeElement.focus(),v.activeElement.classList.add(v.error?"error":"active"),v.error&&v.activeElement.classList.add("x-error")),v.error?(c.status.classList.add("error"),c.status.classList.add("status-error")):(c.status.classList.remove("error"),c.status.classList.remove("status-error")),o.title=v.title=e.title;var n=o.scrollingElement||o.documentElement.scrollTop||o.body;n.scrollTop=0,c.output.innerHTML=e.content,i.hash&&i.replace(v.url+i.hash)}},retry:!1,popstate:function(e){if(!(i.hash&&s.filter(v.url)===s.filter(o.URL)||v.url&&v.url.indexOf("#")>-1)){var t,r=e.state;s.reset(),s.retry=!r,v.error=r&&r.error||!1,r||(v.url=s.filter(o.URL),t=s.nav.activeElement(),s.click(t)),o.activeElement.blur(),s.update(r,!1,t)}},loadstart:function(){c.status&&(c.status.classList.remove("status-done"),c.status.classList.remove("status-start"),t&&clearTimeout(t),t=setTimeout(function(){c.status.classList.add("status-start")},0))},callback:function(e){v.error=e.error||!1,n.replaceState(e,e.title,null),s.update(e,!0)},load:function(){var t=this.response;t=l.valid(function(){return JSON.parse(t)}),e&&clearTimeout(e),s.callback(t===l.valid.error?{error:!0,title:"Server error",content:"<h1>Whoops...</h1><p>Experienced server error. Try to <a class=x-error href="+v.url+">reload</a>"+(v.url===v.origin?"":" or head to <a href="+v.origin+">home page</a>")+"."}:t)},closest:function(e,t){if(!e||!t)return null;if(e.closest)return e.closest(t);for(var r=e.matches||e.webkitMatchesSelector||e.msMatchesSelector;e&&1===e.nodeType;){if(r.call(e,t))return e;e=e.parentNode}return null},resetStatus:function(e){c.status&&(!c.status.classList.contains("status-error")||e&&v.error||c.status.classList.remove("status-error"),c.status.classList.contains("status-done")&&(c.status.classList.remove("status-start"),c.status.classList.remove("status-done")))},listener:function(t){if(t){var a=t.target,i=new RegExp("^"+v.origin+"($|#|/.{1,}).*","i"),l={};if(!a)return;if("A"!==a.tagName&&(a=s.closest(a,"a[href]")),!a||"A"!==a.tagName||!a.hasAttribute("href")||!i.test(a.href.replace(/\/$/,"")))return;if(v.url=a.href.toLowerCase().replace(/(\/)+(?=\1)/g,"").replace(/(^https?:(\/))/,"$1/").replace(/\/$/,""),l.attr=s.filter(v.url,!0),l.address=s.filter(o.URL),l.attr===l.address&&v.url.indexOf("#")>-1)return;if(t.preventDefault(),a.blur(),v.activeElement=a,v.activeNav=a.parentNode===c.nav,!s.retry&&v.activeNav&&(v.error=v.activeElement.classList.contains("x-error")),v.title=v.activeElement.innerText.replace(/\n/,"")||v.activeElement.textContent,v.error&&l.address===o.URL?n.replaceState(null,v.title,v.url):v.error||v.url===o.URL||n.pushState(null,v.title,v.url),!v.error&&!s.retry&&l.attr===l.address||v.activeNav&&v.activeElement.classList.contains("focus"))return;e&&clearTimeout(e),e=setTimeout(function(){o.title=v.title},3),s.resetStatus(),s.nav.nodeList&&(v.error&&v.activeNav&&(v.activeElement.classList.remove("x-error"),v.activeElement.classList.remove("error")),c.focus=c.nav.querySelector(".focus"),c.focus&&c.focus.classList.remove("focus")),v.activeNav&&v.activeElement.classList.add("focus"),r.abort(),r.open("GET",v.origin+"/api"+l.attr.replace(new RegExp("^"+v.origin,"i"),"")),v.error&&r.setRequestHeader("If-Modified-Since","Sat, 1 Jan 2000 00:00:00 GMT"),r.send()}},init:function(){c.status&&c.status.addEventListener("transitionend",s.resetStatus,!0),setTimeout(function(){a.onpopstate=s.popstate},150),n.replaceState({error:v.error,title:v.title,content:c.output.innerHTML},v.title,v.url),r=new XMLHttpRequest,r.onloadstart=s.loadstart,r.onload=s.load,r.onabort=s.reset,o.addEventListener(l.touch?"touchstart":"click",s.listener,!0)}},v.analytics||delete v.analytics,s.init(),v});</script>';
